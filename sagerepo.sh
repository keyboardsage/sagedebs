...
wget "https://stable.dl2.discordapp.net/apps/linux/1.0.136/discord-1.0.136.deb"
wget --content-disposition 'https://canary.discord.com/api/download/ptb?platform=linux&format=deb'
