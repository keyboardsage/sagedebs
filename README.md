...
3. Execute `./sageupdate.sh && sudo ./sagerepo.sh`
4. Now you can install apps contained in the repo (ex: `sudo apt-get install synergy`)
5. Repeat the process periodically (weekly, monthly...whatever) starting from step 3, since new debs get added and old debs get new versions